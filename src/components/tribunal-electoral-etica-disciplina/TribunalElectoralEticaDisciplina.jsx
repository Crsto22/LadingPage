...
const members = [
	{
		name: 'Carlos Enrique',
		lastName: 'Alcántara Arroyo',
		roleKey: 'role.firstVocal',
	},
	{
		name: 'Velia Rosa',
		lastName: 'Huaman Villacríces',
		roleKey: 'role.secondVocal',
	},
];
...
export default function TribunalElectoralEticaDisciplina() {
	const { t } = useLanguage();
	...
	return (
		<section className="relative overflow-hidden bg-surface text-primary">
			...
			<div className="relative mx-auto w-full max-w-[900px] px-[clamp(18px,4vw,64px)] py-[clamp(40px,6vw,80px)]">
				<motion.div
